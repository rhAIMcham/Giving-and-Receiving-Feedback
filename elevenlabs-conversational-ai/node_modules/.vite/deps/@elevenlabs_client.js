...
var h = (i2, s2, t) => s2 in i2 ? e(i2, s2, {
  enumerable: true,
  configurable: true,
  writable: true,
  value: t
}) : i2[s2] = t;
var o = (i2, s2, t) => h(i2, typeof s2 != "symbol" ? s2 + "" : s2, t);
var _ = class {
  constructor() {
    o(this, "_locking");
    o(this, "_locks");
...
var Timestamp = class _Timestamp extends Message {
  ...
  static equals(a, b2) {
    return proto3.util.equals(_Timestamp, a, b2);
  }
};
...
var m = class _m extends c {
  ...
  static async create(e2) {
    ...
    try {
      ...
      let i2;
      const r3 = (null == (o2 = e2.overrides) || null == (o2 = o2.client) ? void 0 : o2.version) || u, c2 = (null == (a = e2.overrides) || null == (a = a.client) ? void 0 : a.source) || "js_sdk";
      if (e2.signedUrl) {
        const t2 = e2.signedUrl.includes("?") ? "&" : "?";
        i2 = `${e2.signedUrl}${t2}source=${c2}&version=${r3}`;
      } else i2 = `${s3}/v1/convai/conversation?agent_id=${e2.agentId}&source=${c2}&version=${r3}`;
      const h3 = ["convai"];
      ...
      }), { conversation_id: g2, agent_output_audio_format: f2, user_input_audio_format: w2 } = v2, y2 = l(null != w2 ? w2 : "pcm_16000"), k2 = l(f2);
      return new _m(t, g2, y2, k2);
    } catch (e3) {
      var s2;
...
var k = class _k extends c {
  ...
  static async create(n) {
    ...
    if ("conversationToken" in n && n.conversationToken) o2 = n.conversationToken;
      ...
      try {
        var a, s2, i2;
        const e2 = (null == (a = n.overrides) || null == (a = a.client) ? void 0 : a.version) || u, t = (null == (s2 = n.overrides) || null == (s2 = s2.client) ? void 0 : s2.source) || "js_sdk", c3 = `${r3 = null != (i2 = n.origin) ? i2 : "https://api.elevenlabs.io", r3.replace(/^wss:\/\//, "https://")}/v1/convai/conversation/token?agent_id=${n.agentId}&source=${t}&version=${e2}`, l2 = await fetch(c3);
    ...
    const c2 = new Room();
    try {
      const e2 = `room_${Date.now()}`, a2 = l("pcm_48000"), s3 = l("pcm_48000"), i3 = new _k(c2, e2, a2, s3, n), r4 = n.livekitUrl || "wss://livekit.rtc.elevenlabs.io";
      var d2;
...
var S = class _S extends r2 {
  static async startSession(e2) {
    ...
    let n = null;
    try {
      return await C(t.connectionDelay), n = await _2(e2), new _S(t, n);
    } catch (e3) {
      var o2;
...
var M = { echoCancellation: true, noiseSuppression: true, autoGainControl: true, channelCount: { ideal: 1 } };
var I = class _I {
  static async create({ sampleRate: e2, format: t, preferHeadphonesForIosDevices: n, inputDeviceId: o2, workletPaths: a, libsampleratePath: i2 }) {
    ...
    try {
      ...
      await y(r3.audioWorklet, null == a ? void 0 : a.rawAudioProcessor);
      ...
      return m2.port.postMessage({ type: "setFormat", format: t, sampleRate: e2 }), p2.connect(d2), d2.connect(m2), await r3.resume(), new _I(r3, d2, m2, c2, p2);
    } catch (e3) {
      var l2, u2;
...
var F = class _F {
  static async create({ sampleRate: e2, format: t, outputDeviceId: n, workletPaths: o2 }) {
    ...
    try {
      ...
      s2.srcObject = c2.stream, r4.connect(i3), i3.connect(c2), await D(a.audioWorklet, null == o2 ? void 0 : o2.audioConcatProcessor);
      const l2 = new AudioWorkletNode(a, "audioConcatProcessor");
      return l2.port.postMessage({ type: "setFormat", format: t }), l2.connect(r4), await a.resume(), n && s2.setSinkId && await s2.setSinkId(n), new _F(a, i3, r4, l2, s2);
    } catch (e3) {
      var i2, r3;
      throw null != (i2 = s2) && i2.parentNode && s2.parentNode.removeChild(s2), null == (r3 = s2) || r3.pause(), a && "closed" !== a.state && await a.close(), e3;
    }
  }
  constructor(e2, t, n, o2, a) {
...
var A = class _A extends r2 {
  static async startSession(e2) {
    ...
    try {
      var u2;
      return c2 = await navigator.mediaDevices.getUserMedia({ audio: true }), await C(n.connectionDelay), a = await _2(e2), [o2, i2] = await Promise.all([I.create(s({}, a.inputFormat, { preferHeadphonesForIosDevices: e2.preferHeadphonesForIosDevices, inputDeviceId: e2.inputDeviceId, workletPaths: e2.workletPaths, libsampleratePath: e2.libsampleratePath })), F.create(s({}, a.outputFormat, { outputDeviceId: e2.outputDeviceId, workletPaths: e2.workletPaths }))]), null == (u2 = c2) || u2.getTracks().forEach((e3) => {
        e3.stop();
      }), c2 = null, new _A(n, a, o2, i2, l2);
    } catch (e3) {
      var d2, h3, p2, m2;
      n.onStatusChange && n.onStatusChange({ status: "disconnected" }), null == (d2 = c2) || d2.getTracks().forEach((e4) => {
        e4.stop();
      }), null == (h3 = a) || h3.close(), await (null == (p2 = o2) ? void 0 : p2.close()), await (null == (m2 = i2) ? void 0 : m2.close());
      try {
        var v2;
  ...
  constructor(e2, t, n, o2, a) {
    super(e2, t), this.input = void 0, this.output = void 0, this.wakeLock = void 0, this.inputFrequencyData = void 0, this.outputFrequencyData = void 0, this.onInputWorkletMessage = (e3) => {
      ...
      this.volume = t2, this.connection instanceof k ? this.connection.setAudioVolume(t2) : this.output.gain.gain.value = t2;
  ...
  handleAudio(e2) {
    var t, n;
    this.lastInterruptTimestamp <= e2.audio_event.event_id && (null == (t = (n = this.options).onAudio) || t.call(n, e2.audio_event.audio_base_64), this.connection instanceof k || this.addAudioBase64Chunk(e2.audio_event.audio_base_64), this.currentEventId = e2.audio_event.event_id, this.updateCanSendFeedback(), this.updateMode("speaking"));
  }
  setMicMuted(e2) {
    this.connection instanceof k ? this.connection.setMicMuted(e2) : this.input.setMuted(e2);
  }
  getInputByteFrequencyData() {
  ...
  getOutputByteFrequencyData() {
    return this.connection instanceof k ? this.connection.getOutputByteFrequencyData() || new Uint8Array(1024) : (null != this.outputFrequencyData || (this.outputFrequencyData = new Uint8Array(this.output.analyser.frequencyBinCount)), this.output.analyser.getByteFrequencyData(this.outputFrequencyData), this.outputFrequencyData);
  }
  getInputVolume() {
  ...
  async changeInputDevice({ sampleRate: e2, format: t, preferHeadphonesForIosDevices: n, inputDeviceId: o2 }) {
    try {
      ...
      this.connection instanceof k && await this.connection.setAudioInputDevice(o2 || ""), await this.input.close();
  ...
  async changeOutputDevice({ sampleRate: e2, format: t, outputDeviceId: n }) {
    try {
      ...
      this.connection instanceof k && await this.connection.setAudioOutputDevice(n || ""), await this.output.close();
...
function E(e2, t, n = "https://api.elevenlabs.io") {
...
export {
  ...
  k as WebRTCConnection,
  m as WebSocketConnection,
  _2 as createConnection,
  E as postOverallFeedback
};
